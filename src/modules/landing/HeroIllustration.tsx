  ...
  return (
    <section className="w-full bg-gray-50 dark:bg-zinc-900 border-y dark:border-zinc-800 relative w-full lg:h-[500px] 2xl:h-[700px] mb-20 flex flex-col gap-4 py-16 px-4 items-center justify-center [&>div:hover~div]:scale-90 [&>div:hover~div]:brightness-50 [&>div:has(~div:hover)]:scale-90 [&>div:has(~div:hover)]:brightness-40">
      <animated.div
        ...
        className="object-cover z-20 lg:absolute shadow-xl w-full max-w-[450px] 2xl:max-w-[550px] transition-all duration-300 lg:translate-x-40 lg:rotate-6 lg:hover:rotate-0 rounded-xl lg:hover:z-30 lg:hover:scale-[110%] hover:brightness-100 brightness-[0.7]"
      >
        <img
      ...
      <animated.div
        ...
        className="object-cover lg:absolute z-10 shadow-xl w-full max-w-[450px] lg:max-w-[600px] 2xl:max-w-[700px] transition-all duration-300 lg:-translate-x-40 rounded-xl transform lg:-rotate-12 lg:hover:z-30 lg:hover:-rotate-0 lg:hover:brightness-100 brightness-[0.7]"
      >
        <img
